...
|------------------------------|-------------------|--------------|--------------|
| Planning Presentation        | Gary              | Oct 24th     | Completed    |
| Project Update Document      | Harman            | Nov 7th      |              |
| Project update Presentation  | Gary              | Nov 7th      |              |

| Tasks                        | Assigned To       | Due Date     | Status       |
|------------------------------|-------------------|--------------|--------------|
| Discuss and decide Tasks     | Full Team         | Oct 23rd     | Completed    |
| Finish up Godot prototype    | Gary              |              | Completed    |
| Added dice assets            | Joseph            |              | Completed    |
| Implemented dice assets      | Gary              |              | Completed    |
| General Project Rework       | Joseph            |              | Completed    |
| Attacking health system      | Abhi              |              | Completed    |
| resolve conflicts            | Joseph            |              | Completed    |
| Cash in for computer         | Abhi              |              | Completed    |
| Main Menu and Classic mode   | Gary              |              | Completed    |
...
| Long Formal Presentation     | Gary              | Oct 17th     | Completed    |
